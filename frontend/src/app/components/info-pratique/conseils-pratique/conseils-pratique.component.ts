...
@Component({
  selector: 'app-conseils-pratique',
  templateUrl: './conseils-pratique.component.html',
  styleUrls: ['./conseils-pratique.component.scss'],
})
export class ConseilsPratiqueComponent implements OnInit {
  constructor() {}
