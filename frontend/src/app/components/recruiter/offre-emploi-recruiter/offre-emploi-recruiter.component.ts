...
@Component({
  selector: 'app-offre-emploi-recruiter',
  templateUrl: './offre-emploi-recruiter.component.html',
  styleUrls: ['./offre-emploi-recruiter.component.scss'],
})
export class OffreEmploiRecruiterComponent implements OnInit {
  constructor() {}
