...
@Component({
  selector: 'app-condida-details',
  templateUrl: './condida-details.component.html',
  styleUrls: ['./condida-details.component.scss'],
})
export class CondidaDetailsComponent implements OnInit {
  N_Etude: any[]
  secteur: any[]
  salutation: any[]
  value8: any
