...
export class ExpectationsFormComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private ref: DynamicDialogRef) {
    this.expectations_form = this.fb.group({
      expectations_form_job_fild_1_input: new FormControl('', [
        Validators.required,
      ]),
      expectations_form_job_fild_2_input: new FormControl('', [
        Validators.required,
      ]),
      expectations_form_job_fild_3_input: new FormControl('', [
        Validators.required,
      ]),
      expectations_form_contry_input: new FormControl('', [
        Validators.required,
      ]),
      ...
      expectations_form_conteract_type_input: new FormControl('', [
        Validators.required,
      ]),
      expectations_form_saliry_input: new FormControl('', [
        Validators.required,
      ]),
    })
  }
